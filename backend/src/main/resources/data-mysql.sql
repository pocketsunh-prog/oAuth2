-- Initial data for MySQL: default admin user (password: admin123)
-- The password is BCrypt-encoded for "admin123"
INSERT INTO users (id, username, email, password, enabled, role, created_at, updated_at) VALUES (
    1,
    'admin',
    'admin@example.com',
...
INSERT INTO oauth2_clients (id, client_id, client_secret, client_name, redirect_uri, authorized_grant_types, scopes, enabled, created_at) VALUES (
    1,
    'frontend-client',
...
ALTER TABLE oauth2_clients AUTO_INCREMENT = 100;
